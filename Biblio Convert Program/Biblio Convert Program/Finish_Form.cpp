...
void BiblioConvertProgram::Finish_Form::Set_Way_File(String^ way_file)
{
    this->way_file = way_file;
}
String^ BiblioConvertProgram::Finish_Form::Get_Way_File()
{
    return this->way_file;
}
...
System::Void BiblioConvertProgram::Finish_Form::button_Finish_Click(System::Object^ sender, System::EventArgs^ e)
{
    if (checkBox_Open->Checked == true)
        Process::Start("notepad.exe", Get_Way_File());
    Application::Exit();
}
